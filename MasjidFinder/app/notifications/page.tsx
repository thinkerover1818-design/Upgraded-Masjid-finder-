...
export default async function NotificationsPage() {
  ...
  const { data: actors } = actorIds.length ? await supabase.from("public_profile_cards").select("id,full_name,profile_picture_url,verification_status").in("id", actorIds) : { data: [] };
